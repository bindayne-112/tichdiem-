function generateQRCode() {
    ...
    if (phoneNumber) {
        ...
        var url = 'https://script.google.com/macros/s/AKfycbwShrIIlv29488F-N1IVPek3NyJEs4njwuwjgMEohoscdX3iBqWnwB2Ir5-Nkg4KX9qBw/exec'; // Đã thay URL này với URL của bạn
        var params = {
